...
-- Notes:
-- - utf8mb4 recommended
-- - JSON columns require MySQL 8+

SET NAMES utf8mb4;
SET time_zone = '+00:00';

-- Drop order (optional) - keep commented to avoid destructive runs
-- DROP TABLE IF EXISTS refresh_tokens, applications, cv_sections, cvs, job_offers, recruiter_profiles, candidate_profiles, users;
